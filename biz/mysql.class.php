...
class Mysql {
    ...
    private function free() {
        ...
        if (property_exists($this, '_query_handle')) unset($this->_query_handle);
        if (property_exists($this, '_operate')) unset($this->_operate);
        if (property_exists($this, '_column')) unset($this->_column);
        if (property_exists($this, '_where')) unset($this->_where);
        if (property_exists($this, '_order')) unset($this->_order);
        if (property_exists($this, '_limit')) unset($this->_limit);
        if (property_exists($this, '_data')) unset($this->_data);
        if (property_exists($this, '_cache')) unset($this->_cache);
        if (property_exists($this, '_result')) unset($this->_result);
        return true;
    }
...
$db->config(Mysql::$_config_default);
